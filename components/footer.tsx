...
const Footer = () => {
	return (
		<footer className="border-t shadow-inner border-cyan-200 bg-gleam dark:bg-shade dark:border-indigo-800">
			<Container>
				<div className="flex flex-col items-center py-24 lg:flex-row">
					...
					<div className="flex flex-col items-center justify-center lg:flex-row lg:pl-4 lg:w-1/2">
						<a href={'https://kerrbe.ar'} className="mx-3 font-bold pretty-link">
							Kerrbear&apos;s
						</a>
						<a href="https://nameless.quest" className="mx-3 font-bold pretty-link">
							Nameless
						</a>
