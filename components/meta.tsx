...
const Meta = () => {
	return (
		<Head>
			...
			<meta name="msapplication-TileImage" content="/favicon/favicon/favicon-144x144.png" />
			...
			<script defer data-domain="easeness.biz" src="https://plausible.io/js/plausible.js"></script>
		</Head>
	);
};
